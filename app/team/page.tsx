      ...
      <section id="team" className="py-24 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            {/* Team Member 1 */}
            <Card className="bg-gray-900/50 border-gray-800 hover:border-purple-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/10 group">
              <CardContent className="pt-8 pb-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-purple-400 mb-3">{t('team.member1.position')}</p>
            ...
            {/* Team Member 2 */}
            <Card className="bg-gray-900/50 border-gray-800 hover:border-blue-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/10 group">
              <CardContent className="pt-8 pb-6">
                <div className="flex flex-col items-center text-center">
                  <div className="w-24 h-24 rounded-full bg-gray-800 mb-4 perspective-[1000px]" style={{perspective: '1000px'}}>
                    <div className="w-full h-full rounded-full transition-transform duration-500 transform-style-3d group-hover:rotate-y-180" style={{transformStyle: 'preserve-3d'}}>
                  ...
                  <p className="text-blue-400 mb-3">{t('team.member2.position')}</p>
                  <p className="text-gray-400 text-sm">
            ...
            {/* Team Member 3 */}
            <Card className="bg-gray-900/50 border-gray-800 hover:border-green-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/10 group">
              <CardContent className="pt-8 pb-6">
                <div className="flex flex-col items-center text-center">
                  <div className="w-24 h-24 rounded-full bg-gray-800 mb-4 perspective-[1000px]" style={{perspective: '1000px'}}>
                    <div className="w-full h-full rounded-full transition-transform duration-500 transform-style-3d group-hover:rotate-y-180" style={{transformStyle: 'preserve-3d'}}>
                      ...
                      {/* Back: Image */}
                      <div className="absolute w-full h-full rounded-full flex items-center justify-center backface-hidden transform-rotate-y-180" style={{backfaceVisibility: 'hidden', transform: 'rotateY(180deg)'}}>
                        <img src="/CY/bfff7bc074b84d13caef1cb5b883e3de.jpg" alt={t('team.member3.name')} className="w-full h-full rounded-full object-cover" />
                      </div>
                    </div>
                  </div>
                  <h3 className="text-xl font-bold text-white mb-1">{t('team.member3.name')}</h3>
                  <p className="text-green-400 mb-3">{t('team.member3.position')}</p>
                  <p className="text-gray-400 text-sm">
            ...
            {/* Team Member 4 */}
            <Card className="bg-gray-900/50 border-gray-800 hover:border-yellow-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-yellow-500/10 group">
              <CardContent className="pt-8 pb-6">
                <div className="flex flex-col items-center text-center">
                  <div className="w-24 h-24 rounded-full bg-gray-800 mb-4 perspective-[1000px]" style={{perspective: '1000px'}}>
                    <div className="w-full h-full rounded-full transition-transform duration-500 transform-style-3d group-hover:rotate-y-180" style={{transformStyle: 'preserve-3d'}}>
                  ...
                  <p className="text-yellow-400 mb-3">{t('team.member4.position')}</p>
                  <p className="text-gray-400 text-sm">
            ...
            {/* Team Member 5 */}
            <Card className="bg-gray-900/50 border-gray-800 hover:border-red-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-red-500/10 group">
              <CardContent className="pt-8 pb-6">
                <div className="flex flex-col items-center text-center">
                  <div className="w-24 h-24 rounded-full bg-gray-800 mb-4 perspective-[1000px]" style={{perspective: '1000px'}}>
                    <div className="w-full h-full rounded-full transition-transform duration-500 transform-style-3d group-hover:rotate-y-180" style={{transformStyle: 'preserve-3d'}}>
                  ...
                  <p className="text-red-400 mb-3">{t('team.member5.position')}</p>
                  <p className="text-gray-400 text-sm">
